...
var Frame = (function (_super) {
    ...
    function Frame() {
        ...
        _this._listener = new android.view.View.OnAttachStateChangeListener({
            onViewAttachedToWindow: _this.onNativeViewAttachedToWindow.bind(_this),
            onViewDetachedFromWindow: _this.onNativeViewDetachedToWindow.bind(_this)
        });
        return _this;
    }
