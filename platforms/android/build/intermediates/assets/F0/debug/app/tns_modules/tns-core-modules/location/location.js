...
var LocationManager = LocationManager_1 = (function () {
            ...
            if (!this._locationListener) {
                this._locationListener = new android.location.LocationListener({
                    onLocationChanged: function (location1) {
                        if (this._onLocation) {
                            var location = LocationManager_1.locationFromAndroidLocation(location1);
                            if (this.maximumAge) {
    ...
    LocationManager.distance = function (loc1, loc2) {
        if (!loc1.android) {
            loc1.android = LocationManager_1.androidLocationFromLocation(loc1);
        }
        if (!loc2.android) {
            loc2.android = LocationManager_1.androidLocationFromLocation(loc2);
        }
    ...
    Object.defineProperty(LocationManager.prototype, "lastKnownLocation", {
        get: function () {
            ...
            try {
                ...
                if (location) {
                    return LocationManager_1.locationFromAndroidLocation(location);
                }
            }
            catch (e) {
...
LocationManager = LocationManager_1 = __decorate([
    Deprecated
], LocationManager);
