...
(function (ios) {
    function createBackgroundUIColor(view, flip) {
        ...
        if (background.hasUniformBorder()) {
            ...
            var top_1 = background.borderTopWidth;
            ...
            var lti = { x: nativeViewLayerBounds.left + left, y: nativeViewLayerBounds.top + top_1 };
            var rto = { x: nativeViewLayerBounds.right, y: nativeViewLayerBounds.top };
            var rti = { x: nativeViewLayerBounds.right - right, y: nativeViewLayerBounds.top + top_1 };
            ...
            if (top_1 > 0 && background.borderTopColor && background.borderTopColor.ios) {
