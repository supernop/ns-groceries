...
var Animation = (function (_super) {
    ...
    function Animation(animationDefinitions, playSequentially) {
        ...
        if (!playSequentially) {
            if (trace.enabled) {
                trace.write("Non-merged Property Animations: " + _this._propertyAnimations.length, trace.categories.Animation);
            }
            _this._mergedPropertyAnimations = Animation._mergeAffineTransformAnimations(_this._propertyAnimations);
            if (trace.enabled) {
                trace.write("Merged Property Animations: " + _this._mergedPropertyAnimations.length, trace.categories.Animation);
            }
        }
        else {
