...
function onYearPropertyChanged(data) {
    ...
    if (picker.ios) {
        var comps = utils.ios.getter(NSCalendar, NSCalendar.currentCalendar).componentsFromDate(4 | 8 | 16, picker.ios.date);
...
var UIDatePickerChangeHandlerImpl = (function (_super) {
    ...
    UIDatePickerChangeHandlerImpl.prototype.valueChanged = function (sender) {
        var comps = utils.ios.getter(NSCalendar, NSCalendar.currentCalendar).componentsFromDate(4 | 8 | 16, sender.date);
