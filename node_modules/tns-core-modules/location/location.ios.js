...
var LocationManager = LocationManager_1 = (function () {
    ...
    LocationManager.isEnabled = function () {
        if (CLLocationManager.locationServicesEnabled()) {
            return (CLLocationManager.authorizationStatus() === 4
    ...
    LocationManager.distance = function (loc1, loc2) {
        if (!loc1.ios) {
            loc1.ios = LocationManager_1.iosLocationFromLocation(loc1);
        }
        if (!loc2.ios) {
            loc2.ios = LocationManager_1.iosLocationFromLocation(loc2);
        }
    ...
    Object.defineProperty(LocationManager.prototype, "lastKnownLocation", {
        get: function () {
            ...
            if (clLocation) {
                return LocationManager_1._locationFromCLLocation(clLocation);
            }
            return null;
        },
        enumerable: true,
